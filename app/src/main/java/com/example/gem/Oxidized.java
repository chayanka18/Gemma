...
public class Oxidized extends AppCompatActivity
{
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products> options = new FirebaseRecyclerOptions.Builder<Products>()
                .setQuery(ProductRef.orderByChild("category").equalTo("oxy"), Products.class)
                .build();
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
                ...
                if (productPrice >= minPrice && productPrice <= maxPrice) {
                    ...
                    holder.itemView.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(Oxidized.this, ProductDetails.class);
        ...
        builder.setPositiveButton("Apply", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (minPrice.isEmpty() && maxPrice.isEmpty()) {
                    Toast.makeText(Oxidized.this, "Please enter a price range", Toast.LENGTH_SHORT).show();
                } else {
