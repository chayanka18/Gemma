...
public class ConfirmFinalOnlineOrder extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intValue = Integer.parseInt(totalAmount);
...
progressBar=findViewById(R.id.confirm);
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task)
                            {
                                if(task.isSuccessful())
                                {
                                    ...
                                    Toast.makeText(ConfirmFinalOnlineOrder.this, "Thank You for purchasing,Details collected ", Toast.LENGTH_SHORT).show();
                                    Intent i=new Intent(ConfirmFinalOnlineOrder.this,RazorPay.class);
                                    i.putExtra("amount",intValue);
